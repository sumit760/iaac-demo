...
public class SignInToXfinity extends SeleniumPageObject<SignInToXfinity> {
	...
	public SignInToXfinity(String inCustomUrl, WebDriver driver) {
	...
	protected void isLoaded() throws Error {
		...
		Assert.assertTrue(path.startsWith("/login") || url.contains("create-uid"),
				"Current page URL should contain '/login' or 'create-uid', but the actual value is '"
						+ url + "'");
	}
	...
	public boolean isUsernameFieldPresent(){
		return this.isElementPresent(this.userName);
	}	
	...
	private String getURLToLoad() {
		...
		if (this.customUrl != null) {
			...
			outValue = ObjectInitializer.getCache(ICommonConstants.CACHE_CONFIGURARTION_PARAMS).getString(EndPoinUrlProvider.LoginUrlPropKeys.XFINITY_SIGNIN.getValue(), 
